<%@ Page Title="" Language="C#" MasterPageFile="~/MasterLayout.Master" AutoEventWireup="true" CodeBehind="Luong_Vasdealer.aspx.cs" Inherits="VNPT_BSC.BSC.Luong_Vasdealer" %>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title">Lương hệ thống Vas Dealer của NVKD/CTV</h3>
          </div>
          <div class="panel-body">
              ...
              <div class="col-md-12 col-xs-12 form-horizontal">
                ...
                <h5 style="color:red; text-align:center; font-weight:bold">Hệ thống tự động đồng bộ vào lúc 14h mỗi ngày.</h5>
                <div class="form-group">
                    <label class="control-label col-sm-4">Thời điểm chi lương:</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" id="nhomctv">
                            <option value="0" selected="selected">Tất cả</option>
                            <option value="1">Nhân viên KDTT</option>
                            <option value="2">Cộng tác viên KDTT</option>
                            <option value="3">Giao dịch viên</option>
                            <option value="4">Điểm ủy quyền</option>
                            <option value="7">CTV Thu cước</option>
                            <option value="8">Đội Hậu</option>
                            <option value="9">Đội Dung</option>
                            <option value="10">Đội Tuấn</option>
...
<script type="text/javascript">
    function loadTB() {
        ...
        $.ajax({
            type: "POST",
            url: "Luong_Vasdealer.aspx/loadTB",
            data: szRequest,
