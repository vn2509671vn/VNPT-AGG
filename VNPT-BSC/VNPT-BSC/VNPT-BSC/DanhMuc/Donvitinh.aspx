<%@ Page Title="" Language="C#" MasterPageFile="~/MasterLayout.Master" AutoEventWireup="true" CodeBehind="Donvitinh.aspx.cs" Inherits="VNPT_BSC.DanhMuc.Donvitinh" %>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">DANH MỤC ĐƠN VỊ TÍNH</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12 col-xs-12">
                    <div class="table-responsive fix-border-table">
                        <a class="btn btn-success btn-xl fix-label-margin-top" data-toggle="modal" data-target="#themdvt">Thêm đơn vị tính</a>
                        <table id="table-dvt" class="table table-striped table-bordered table-full-width" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <% for (int i = 0; i < dtdvt.Rows.Count; i++)
                                   { %>
                                <%
                                    string dvt_id = dtdvt.Rows[i][0].ToString();
                                    string dvt_ten = dtdvt.Rows[i][1].ToString();
                                    string dvt_mota = dtdvt.Rows[i][2].ToString();
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content col-md-12">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" style="text-align: center">Thêm đơn vị tính</h4>
                                    </div>
                                    <div class="modal-body list-BSC form-horizontal">
                                        <div class="form-group">
                                            <label class="control-label col-sm-4">Tên đơn vị tính:</label>
                                            <div class="col-sm-8">
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn btn-success" id="btnSave">Thêm đơn vị tính</a>
                        ...
                        <div id="Editdonvitinh" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content col-md-12">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 class="modal-title">Chỉnh sửa đơn vị tính</h4>
                                    </div>
