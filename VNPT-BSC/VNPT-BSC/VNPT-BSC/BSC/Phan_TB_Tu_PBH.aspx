<%@ Page Title="" Language="C#" MasterPageFile="~/MasterLayout.Master" AutoEventWireup="true" CodeBehind="Phan_TB_Tu_PBH.aspx.cs" Inherits="VNPT_BSC.BSC.Phan_TB_Tu_PBH" %>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title">PHÂN THUÊ BAO CHO NHÂN VIÊN BẰNG FILE EXCEL</h3>
          </div>
          <div class="panel-body">
              <div class="col-md-12 col-xs-12 form-horizontal">
                <div class="form-group">
                    <label class="control-label col-sm-5">Chọn thời gian giao:</label>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-5">Chọn file:</label>
                    <div class="col-sm-6 form-inline">
