<%@ Page Title="" Language="C#" MasterPageFile="~/MasterLayout.Master" AutoEventWireup="true" CodeBehind="KPI_PhongBanChucNang.aspx.cs" Inherits="VNPT_BSC.DanhMuc.KPI_PhongBanChucNang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        function editdata(kpi_id, kpi_ten, kpi_ma, kpi_mota, kpi_ngaytao, kpi_thuockpo) {
                ...
                closeOnCancel: false
                   ...
                   function (isConfirm) {
                       if (isConfirm) {
                           ...
                           $.ajax({
                               type: "POST",
                               url: "KPI_PhongBanChucNang.aspx/DeleteData",
                               data: szRequest,
        ...
        $(document).ready(function () {
            ...
            $("#btnSave").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "KPI_PhongBanChucNang.aspx/SaveData",
                    data: szRequest,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (result) {
            ...
            $('#btnEdit').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "KPI_PhongBanChucNang.aspx/EditData",
                    data: szRequest,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (result) {
