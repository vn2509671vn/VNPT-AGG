...
{
    public partial class Luong3PS : System.Web.UI.Page
    {
        ...
        public static DataTable chitiet(int nhom, int thang, int nam)
        {
            ...
            string sql = "select nv.id, nv.ma_nhanvien, chitiet.ten_nhanvien, chitiet.heso_lcb, isnull(chitiet.luong_coban,0) as luong_coban, isnull(chitiet.diem_p1,0) as diem_p1, isnull(chitiet.heso_bsc,0) as heso_bsc, isnull(chitiet.luong_3ps,0) as luong_3ps, isnull(chitiet.luong_pttb,0) as luong_pttb, isnull(chitiet.luong_congthem,0) as luong_congthem, (isnull(chitiet.luong_3ps,0) + isnull(chitiet.luong_pttb,0) + isnull(chitiet.luong_congthem,0)) as luongphanphoi ";
        ...
        public static string loadLuong(int thang, int nam)
        {
            ...
            for (int nNhom = 0; nNhom < dtNhom.Rows.Count; nNhom++)
            {
                ...
                {
                    if (Convert.ToInt32(dtChiTiet.Rows[nChiTiet]["id"].ToString()) == 3) {
                        continue;
                    }
