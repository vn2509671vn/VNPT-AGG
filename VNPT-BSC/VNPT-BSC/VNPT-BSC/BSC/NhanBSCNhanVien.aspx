<%@ Page Title="" Language="C#" MasterPageFile="~/MasterLayout.Master" AutoEventWireup="true" CodeBehind="NhanBSCNhanVien.aspx.cs" Inherits="VNPT_BSC.BSC.NhanBSCNhanVien" %>
...
<script type="text/javascript">
    function xemChiTiet(thang, nam, nhanviengiao, nhanviennhan) {
        window.location.replace("ChiTietBSCNVNhan.aspx?nhanviengiao=" + nhanviengiao + "&nhanviennhan=" + nhanviennhan + "&thang=" + thang + "&nam=" + nam);
    }

    function loadBSCByYear(year, nhanviennhan) {
        var requestData = {
        ...
        $.ajax({
            type: "POST",
            url: "NhanBSCNhanVien.aspx/loadBSCByYear",
            data: szRequest,
    ...
    $(document).ready(function () {
        ...
        $("#year").change(function () {
            var nam = $(this).val();
            loadBSCByYear(nam, nhanviennhan);
        });
    });
</script>
</asp:Content>
