...
namespace VNPT_BSC
{
    public partial class index : System.Web.UI.Page
    {
        ...
        public static Dictionary<String, String> loadBSCByYear(int thang, int nam, int nhanvien_donvi_id)
        {
            ...
            outputHTML += "<th>Kết quả thực hiện</th>";
            outputHTML += "<th>Điểm KPI</th>";
            ...
            {
                outputHTML += "<tr><td colspan='15' class='text-center'>No item</td></tr>";
            }
            else
            {
                for (int nIndex = 0; nIndex < gridData.Rows.Count; nIndex++)
                {
                    ...
                    string dv_ketqua = gridData.Rows[nIndex]["kq_thuchien"].ToString();
                    string dv_diem = gridData.Rows[nIndex]["diem_kpi"].ToString();
                    ...
                    outputHTML += "<td class='text-center'>" + gridData.Rows[nIndex]["dvg"].ToString() + "</td>";
                    outputHTML += "<td class='text-center'>" + gridData.Rows[nIndex]["kpi_ten"].ToString() + "</td>";
                    outputHTML += "<td class='text-center'>" + gridData.Rows[nIndex]["dvtd"].ToString() + "</td>";
                    ...
                    outputHTML += "<td class='text-center'>" + gridData.Rows[nIndex]["kq_thuchien"].ToString() + "</td>";
                    outputHTML += "<td class='text-center'>" + gridData.Rows[nIndex]["diem_kpi"].ToString() + "</td>";
