<%@ Page Title="" Language="C#" MasterPageFile="~/MasterLayout.Master" AutoEventWireup="true" CodeBehind="DanhSachBSCDaGiao_ThamDinh.aspx.cs" Inherits="VNPT_BSC.BSC.DanhSachBSCDaGiao_ThamDinh" %>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title">Dữ liệu BSC đơn vị được thẩm định</h3>
          </div>
          <div class="panel-body">
              <div class="col-md-12 col-xs-12 form-horizontal">
                <div class="form-group">
                    <p class="red-color text-center">Dữ liệu được thẩm định tính tới thời điểm hiện tại</p>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    function loadBSCByYear(month, year, loaibsc) {
        ...
        $.ajax({
            type: "POST",
            url: "DanhSachBSCDaGiao_ThamDinh.aspx/loadBSCByYear",
            data: szRequest,
                    ...
                    "buttons": [
                        {
                            ...
                            action: function (e, dt, node, config) {
                                ExportTableToExcel('table-bsclist', 'BSC 11 ĐVHT được thẩm định ' + month + '-' + year);
                            }
                        }
                    ],
                    "columnDefs": [{
