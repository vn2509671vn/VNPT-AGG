<%@ Page Title="" Language="C#" MasterPageFile="~/MasterLayout.Master" AutoEventWireup="true" CodeBehind="ImportNhanVien_TinhLuong.aspx.cs" Inherits="VNPT_BSC.TinhLuong.PhatTrienThueBao" %>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title">Import danh sách nhân viên để tính lương</h3>
          </div>
          <div class="panel-body">
              <div class="col-md-12 col-xs-12 form-horizontal">
                <div class="form-group">
                    <label class="control-label col-sm-4">Chọn thời gian:</label>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4">Chọn file:</label>
                    <div class="col-sm-6 form-inline">
                ...
                <h5 class="red-color text-center"><a  href="../Upload/DongBoDiemP1.xlsx">Tải về file mẫu</a></h5>
              </div>
          </div>
        </div>
    </div>
