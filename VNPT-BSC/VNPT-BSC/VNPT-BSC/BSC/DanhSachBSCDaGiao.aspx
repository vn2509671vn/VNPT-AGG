<%@ Page Title="" Language="C#" MasterPageFile="~/MasterLayout.Master" AutoEventWireup="true" CodeBehind="DanhSachBSCDaGiao.aspx.cs" Inherits="VNPT_BSC.BSC.DanhSachBSCDaGiao" %>
...
<script type="text/javascript">
    function loadBSCByYear(month, year) {
        ...
        $.ajax({
            type: "POST",
            url: "DanhSachBSCDaGiao.aspx/loadBSCByYear",
            data: szRequest,
