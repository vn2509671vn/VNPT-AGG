...
namespace VNPT_BSC.Admin
{
    public partial class ImportExcel : System.Web.UI.Page
    {
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            gDonvigiao = Convert.ToInt32(DropDownListDVG.SelectedValue.ToString());
            gNguoitao = Convert.ToInt32(DropDownListCVBSC.SelectedValue.ToString());
        ...
        private void Import_To_Grid(string FilePath, string Extension, string isHDR, int thang, int nam)
        {
            ...
            for (int nColIndex = 4; nColIndex < headers.Count; nColIndex++)
            {
                ...
                for (int nRowIndex = 0; nRowIndex < dtResult.Rows.Count; nRowIndex++) {
                    ...
                    int kpi_id = Convert.ToInt32(dtResult.Rows[nRowIndex][0].ToString().Trim());
                    int kehoach = Convert.ToInt32(dtResult.Rows[nRowIndex][nColIndex].ToString().Trim());
