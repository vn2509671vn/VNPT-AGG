<%@ Page Title="" Language="C#" MasterPageFile="~/MasterLayout.Master" AutoEventWireup="true" CodeBehind="ImportExcel.aspx.cs" Inherits="VNPT_BSC.Admin.ImportExcel" %>
        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
              <div class="col-sm-12 form-horizontal">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-6">Chuyên viên BSC:</label>
                    <div class="col-sm-6 form-inline">
                        <asp:DropDownList runat="server" ID="DropDownListCVBSC" class="form-control"></asp:DropDownList>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-6">Đơn vị giao:</label>
                    <div class="col-sm-6 form-inline">
                        <asp:DropDownList runat="server" ID="DropDownListDVG" class="form-control"></asp:DropDownList>
                    </div>
                </div>
                <div class="form-group">
